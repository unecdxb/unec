            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full pr-4 py-3 border-b focus:border-black/40 focus:outline-none placeholder-black/60 focus:placeholder-black/40 ${errors.fullName ? 'border-red-500' : 'border-black/20'
                    }`}
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full pr-4 py-3 border-b focus:outline-none focus:border-black/40 placeholder-black/60 focus:placeholder-black/40 ${errors.email ? 'border-red-500' : 'border-black/20'
                    }`}
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full pr-4 py-3 border-b focus:border-black/40 placeholder-black/60 focus:outline-none focus:placeholder-black/40 ${errors.phone ? 'border-red-500' : 'border-black/20'
                    }`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full pr-4 py-3 border-b focus:border-black/40 placeholder-black/60 focus:outline-none focus:placeholder-black/40 ${errors.linkedIn ? 'border-red-500' : 'border-black/20'
                    }`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2  gap-6">
              ...
              <div>
                ...
                <textarea
                  ...
                  className={`w-full pr-4 py-3 border-b focus:outline-none placeholder-black/60 focus:placeholder-black/40 focus:border-black/40 ${errors.coverLetter ? 'border-red-500' : 'border-black/20'
                    }`}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full pr-4 py-3 border-b placeholder-black/60 focus:border-black/40 focus:outline-none focus:placeholder-black/40 ${errors.expectedSalary ? 'border-red-500' : 'border-black/20'
                    }`}
