...
const validateFile: (fileList: FileList | undefined) => true | string = (fileList) => {
            ...
            if (uploadedFile) {
                ...
                if (fileData.url) {
                    ...
                    if (res.success) {
                        ...
                        // clear selected job from context
                        setJobSelect("");
                    } else {
                        alert(res.message);
                        setSubmitStatus({
                ...
                >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full pr-4 py-3 border-b focus:border-black/40 focus:outline-none placeholder-black/60 focus:placeholder-black/40 ${
                  ...
                  Email Address <span className="text-red-500">*</span>
                                ...
                                <input
                                    ...
                                    className={`w-full pr-4 py-3 border-b focus:outline-none focus:border-black/40 placeholder-black/60 focus:placeholder-black/40 ${
                  ...
                  Phone Number <span className="text-red-500">*</span>
                                ...
                                <input
                                    ...
                                    className={`w-full pr-4 py-3 border-b focus:border-black/40 placeholder-black/60 focus:outline-none focus:placeholder-black/40 ${
                  ...
                  LinkedIn Profile (Optional)
                                ...
                                <input
                                    ...
                                    className={`w-full pr-4 py-3 border-b focus:border-black/40 placeholder-black/60 focus:outline-none focus:placeholder-black/40 ${
                                        errors.linkedIn ? "border-red-500" : "border-black/20"
                                    }`}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2  gap-6">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    className={`w-full pr-4 py-3 border-b focus:outline-none placeholder-black/60 focus:placeholder-black/40 focus:border-black/40 ${
                                        errors.coverLetter ? "border-red-500" : "border-black/20"
                                    }`}
                                ...
                                >
                                    {!uploadedFile ? (
                                        ...
                                        <div className="flex items-center justify-between bg-white p-3 rounded border border-gray-200">
                                            ...
                                            {/* prevent opening file dialog when clicking remove */}
                                            <button
                                                type="button"
                                                onClick={(e) => {
                                                    e.preventDefault();
  ...
  render={({ field: { onChange } }) => (
    <input
      ...
      onChange={(e) => {
        ...
        setUploadedFile(files[0]);
        onChange(files); // 🔥 THIS updates RHF correctly
      }}
    />
  )}
/>
                  ...
                  Expected Salary <span className="text-red-500">*</span>
                                ...
                                <input
                                    ...
                                    className={`w-full pr-4 py-3 border-b placeholder-black/60 focus:border-black/40 focus:outline-none focus:placeholder-black/40 ${
                                        errors.expectedSalary ? "border-red-500" : "border-black/20"
                                    }`}
