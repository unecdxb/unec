      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 xl:gap-20 items-center bg-light px-6 py-8 xl:px-12 xl:py-15">
          ...
          <div className="xl:order-1">
            <h3 className="text-32 uppercase text-secondary font-normal mb-2 xl:mb-4">WHY WORK WITH US</h3>
            <div className="space-y-4">
              <p className="">Joining [UNEC] makes you part of a team which is dedicated to achieving the highest level of excellence in best practices, creativity and cutting-edge thinking. Together we aim to turn the vision of a project into reality.</p>
              <p className="">We always believe that a new project is a new challenge. And each challenge adds valuable experience to the team. With the large variety of UNEC’s project portfolio ranging from towers, malls, schools, hospitals, villas to the most iconic developments. [UNEC] is always keen to pass on this knowledge and expertise to the generations of tomorrow.</p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 xl:gap-20 items-center bg-light px-6 py-8 xl:px-12 xl:py-15">
          ...
          <div className="">
            <h3 className="text-32 uppercase text-secondary font-normal  mb-2 xl:mb-4">BENEFITS OF WORKING WITH [UNEC]</h3>
           <div className="space-y-4">
              <p className="">At [UNEC], we have a “one team, one family” culture. UNEC continuously demonstrates strong commitment to the ongoing development of our people.</p>
              <p className="">Our employee’s job satisfaction and career path development is always a top Priority at [UNEC]. The Employee Performance Appraisal Scheme and training & development programs, as well as the introduction of S.M.A.R.T goal settings and Key Performance Indicators KPI’s, ensures that we tailor career prospects to every individuals’ needs and always focus on encouraging employee-led career conversations.</p>
           </div>
          </div>
        </div>
      </div>
