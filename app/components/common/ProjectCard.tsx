...
const ProjectCard = ({image,title,location,height}:ProjectCardProps) => {
  return (
    <div className={`group relative flex flex-col justify-end overflow-hidden  ${height ? height :"h-[250px] xl:h-[300px]"}`}>
      ...
      <div className="max-lg:absolute max-lg:opacity-100 max-lg:inset-0 max-lg:flex max-lg:flex-col max-lg:justify-center max-lg:bg-black/40 relative p-4 xl:p-5 opacity-0 group-hover:opacity-100 bg-black/70  transition-all duration-500 z-10">
