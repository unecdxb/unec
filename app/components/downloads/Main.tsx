...
const Main = ({ fileName, file, image, imageAlt, description, date }: { fileName: string, file: string, image: string, imageAlt: string, description?: string, date?: string }) => {
            ...
            >
                <div>
                    <div className="relative w-full h-screen">
                        ...
                        <div className="h-screen mx-auto" style={{ paddingLeft: window.innerWidth < 1024 ? 0 : `${leftOffset}px` }}>
                            <div className="relative z-20 h-full flex flex-col justify-end">
                                <div className='xl:w-[44%] p-[28px] bg-black/50 pb-14'>
                  ...
                  transition-all duration-1000 ease-out font-suisse-intl mb-4 xs:mb-5 xl:mb-5 opacity-100 translate-y-0 uppercase`}  >
                                    ...
                                    <div className='flex justify-between lg:items-center lg:flex-row flex-col max-lg:gap-4 max-lg:w-fit'>
                                        <button className="
  px-8 py-2
  border border-white
  text-white
