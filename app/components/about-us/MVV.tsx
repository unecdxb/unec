    ...
    <section className="">
      <div className="container border-t border-gray-300 sp-py">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 xl:gap-20">
          <div>
            <div className="bg-primary mb-5 rounded-full p-4 w-20 h-20 xl:w-25 xl:h-25 flex items-center justify-center">
            ...
            <h3 className="text-50 text-secondary font-light mb-2 xl:mb-4 uppercase">Mission</h3>
          ...
          <div>
            ...
            <h3 className="text-50 text-secondary font-light mb-2 xl:mb-4 uppercase">Vision</h3>
            <hr className="h-1 bg-gradient-to-r from-black/20 to-transparent border-0 mb-4" />
          ...
          <div>
            ...
            <h3 className="text-50 text-secondary font-light mb-2 xl:mb-4 uppercase">Promise</h3>
            <hr className="h-1 bg-gradient-to-r from-black/20 to-transparent border-0 mb-4" />
