...
const AwardsRecognitions = ({ data }: { data: AboutData["sixthSection"] }) => {
  return (
    <section className="sp-py relative" id="awards-recognition">
      ...
      <Image src={data.image} alt={data.imageAlt} width={1920} height={1080} className="w-full h-full object-cover absolute top-0 left-0 z-0" />
      <div className="container relative z-10 text-white">
        <SubTitle title={data.title} mClass="mb-6 md:mb-10 xl:mb-15 2xl:mb-20" titleColor="text-white" />
        <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-3 gap-x-12">
          {
