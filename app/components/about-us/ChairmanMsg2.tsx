                ...
                <div className="">
                    <div>
                        <div
                            ...
                            style={{
                                backgroundImage: isMobile ? "" : `url(${data.image})`,
                        ...
                        >
                            ...
                            <div ref={containerRef} className="container invisible pointer-events-none" />
                                ...
                                <div className="pr-16" style={{ paddingLeft: `${leftOffset}px` }}>
                                    ...
                                    <div className="mt-6">
                                        ...
                                        <motion.p
                                            ...
                                            whileInView="show"
                                            viewport={{ amount: 0.1, once: true }}
                                            className=" font-suisse-intl text-14"
                                        >
                                            <span className="font-semibold text-14 ">[ </span>
                                            <span className=" font-bold  text-primary">{data.designation}</span>
                                            <span className="font-semibold  uppercase text-14 "> ]</span>
                                        </motion.p>
                                    </div>
                                </div>
                            </div>
