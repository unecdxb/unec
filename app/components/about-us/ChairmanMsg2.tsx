...
const ChairmanMsg2 = () => {
    ...
    return (
        <section>
            ...
            >
                <div>
                    <div className="relative w-full pt-1" style={{ backgroundImage: isMobile ? "" : "url('/assets/images/about-us/abt-main.jpg')", backgroundSize: "cover", backgroundPosition: "top" }}>
                        ...
                        <div className="w-full lg:hidden">
                            {isMobile && <Image src="/assets/images/about-us/abt-main.jpg" alt="Chairman" width={100} height={100} className="w-full h-full object-cover" />}
                        </div>
                        <div className="lg:py-25 py-10 relative md:bg-black/60 bg-black lg:w-[50%] flex justify-center items-center text-white max-lg:flex-col">
                            ...
                            <div className="pr-16" style={{ paddingLeft: `${leftOffset}px` }}>
                                ...
                                <div className="mt-6">
                                    <motion.h3 variants={moveUp(1)} initial="hidden" whileInView="show" viewport={{ amount: 0.1, once: true }} className="text-14 font-bold">Eng. Abdulhalim Muwahid</motion.h3>
                                    <motion.p variants={moveUp(1.2)} initial="hidden" whileInView="show" viewport={{ amount: 0.1, once: true }} className=" font-suisse-intl text-14"><span className="font-light  uppercase text-24 ">[</span><span className=" font-bold uppercase text-primary">Chairman</span><span className="font-light  uppercase text-24 ">]</span></motion.p>
                                </div>
                            </div>
                        </div>
                    </div>
