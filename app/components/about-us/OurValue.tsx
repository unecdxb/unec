      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 xl:gap-20 sp-pt">
          <div>
            ...
            <div>
              <h3 className="text-25 font-light text-secondary mb-2 xl:mb-4">[ Engineering ] Solutions</h3>
          ...
          <div>
            ...
            <div>
              <h3 className="text-25 font-light text-secondary mb-2 xl:mb-4">[ Construction ] Done Well</h3>
          ...
          <div>
            ...
            <div>
              <h3 className="text-25 font-light text-secondary mb-2 xl:mb-4">[ Company ] Unlimited</h3>
