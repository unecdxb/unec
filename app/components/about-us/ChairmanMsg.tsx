          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 xl:gap-20 items-stretch">
            ...
            <div>
              ...
              <div className="mt-6">
                ...
                <p className=" font-suisse-intl"><span className="font-light uppercase text-24 ">[</span><span className="font-light uppercase text-primary">Chairman</span><span className="font-light uppercase text-24 ">]</span></p>
              </div>
            </div>
          </div>
        </div>
