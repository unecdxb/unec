...
const PageBanner = ({ data }: { data: NewsData['news'] }) => {
                ...
                {data.map((slide, index) => (
                    <SwiperSlide key={index}>
                        <div className="relative w-full h-screen">
                            <Image src={slide.banner} alt={slide.bannerAlt} fill className="object-cover" priority={index === 0} />
                  ...
                  transition-all duration-1000 ease-out font-suisse-intl mb-4 xs:mb-5 xl:mb-5 ${activeIndex === index ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`} style={{ transitionDelay: activeIndex === index ? '300ms' : '0ms' }} >
                                    ...
                                    <div className={`w-10 h-1 bg-primary mb-5 xl:mb-10 ${activeIndex === index ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`} style={{ transitionDelay: activeIndex === index ? '400ms' : '0ms' }} />
